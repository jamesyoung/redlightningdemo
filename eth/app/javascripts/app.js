...
window.App = {
  ...
  sendCoin: function() {
    ...
    var receiver = "0x1234567890123456789012345678901234567890";//document.getElementById("receiver").value;
    ...
    MetaCoin.deployed().then(function(instance) {
      meta = instance;
      return meta.sendCoin(receiver, amount, String(amount), {from: account});
    }).then(function() {
